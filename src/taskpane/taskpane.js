...
//#region ON READY -----------------------------------------------------------------------------------------------------------------------------------
    ...
    Office.onReady((info) => {
        ...
        if (info.host === Office.HostType.Excel) {
            ...
            eventsOn();
            console.log("Events: ON  ‚Üí  turned on in onReady function!");
            //updateDropDowns();
        };
    });
    ...
    //#region ADDING A PROJECT FROM TASKPANE ---------------------------------------------------------------------------------------------------------
        ...
        //#region ADD A PROJECT ----------------------------------------------------------------------------------------------------------------------
            ...
            async function addAProject() {
                ...
                eventsOn();
                console.log("Events: ON  ‚Üí  turned on in the addAProject function after a project was added to the sheet through the taskpane!");
                ...
                await context.sync();
                    ...
                    //#region ROW DELETED ------------------------------------------------------------------------------------------------------------
                        ...
                        if (changeType == "RowDeleted") {
                            ...
                            eventsOn();
                            console.log("Events: ON  ‚Üí  turned on after a row was deleted within the onTableChanged function!");
...
          ⁄À          ·À          ór         „Âªr         Ñ}≈r         5>s         ’®≈r         ú∫t         §!∫t         âF∫t    ,     D  T  d  t  Ñ  î  §  ¥  ƒ  ‘  ‰        AƒU9ró+/                                	            ı     	  file:///     Macintosh HD      0à>Ô         Aƒ@‡   $     F76374A9-E285-4CFD-8164-1BD6FC6AF277     Å      Ô                  /              NSURLDocumentIdentifierKey       qo T    2a565ecfb41a090b79f709314b544bda4656be32cb6c86423f4244a54f52567f;00;00000000;00000000;00000000;0000000000000020;com.apple.app-sandbox.read-write;01;01000007;0000000074ba4689;16;/users/matthewcalvert/library/cloudstorage/onedrive-mailshark/merge_products/other-variable-projects/postcards/prestige-european-auto/2022-08/bleeds no crops2.pdf ‰   ˛ˇˇˇ                    Ù        8      @  (                  t         Ñ         ∏         ò         ®          ‰      0         ¿  X      ¿          ¿  h      –         Ä  H       Ä<      _¢/Users/matthewcalvert/Library/CloudStorage/OneDrive-MailShark/Merge_Products/Other-Variable-Projects/Postcards/Prestige-European-Auto/2022-08/BLEEDS NO CROPS2.pdfHøbGw9UƒA”è  úùûO∏book∏    0              atestFunctionEverWritten(destHead, name, destRowValues, destTable, destRowInfo, 0)
                ...
                console.log("Events: ON  ‚Üí  turned on at the end of the onTableChanged Function!");
            ...
            async function registerOnActivateHandler() {
                await Excel.run(async (context) => {
                    ...
                    if (activeSheet.name == "Validation") {
                        ...
                        eventsOn();
                        console.log("Events: ON  ‚Üí  turned on in the registerOnActivateHandler function, but for the Validation sheet");
                        return;
                    };
                    ...
                    eventsOn();
                    console.log("Events: ON  ‚Üí  turned on in the registerOnActivateHandler function, typically triggered by a reload");
